    ...
    <div className="pb-24 pt-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-16 lg:grid-cols-3">
              ...
              <div className="mt-12">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {(service.features as string[]).map((feature) => (
                    <div
                      key={feature}
                      className="flex items-center gap-3 rounded-lg border border-[#1f1f25] bg-[#111116] p-4"
                    >
          ...
          {/* Sidebar - CTA form */}
          <div>
            <div className="sticky top-24 rounded-xl border border-[#1f1f25] bg-[#111116] p-6">
